        ...
        switch ($this->filter->for()) {
            case 'user':
                return ($this->user === null?false:
                    $this->filterTester->evaluate($this->filter, $this->user) === true);
            case 'group':
                return ($this->group === null?false:
                    $this->filterTester->evaluate($this->filter, $this->group) === true);
            case 'role':
                return ($this->role === null?false:
                    $this->filterTester->evaluate($this->filter, $this->role) === true);
        }
    }
