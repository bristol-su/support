...
namespace BristolSU\Support\Tests\EventStore;
...
use BristolSU\Support\EventStore\EventStoreListener;
...
class EventStoreListenerTest extends TestCase
{
    ...
    public function handle_passes_attributes_to_be_created_to_the_repository()
    {
        ...
        $listener = new EventStoreListener(new \BristolSU\Support\ModuleInstance\ModuleInstanceRepository, $eventStoreRepository->reveal());
        $listener->handle($event);
    }
    ...
    public function handle_creates_a_row_in_the_database(){
        ...
        $listener = new EventStoreListener(
            new \BristolSU\Support\ModuleInstance\ModuleInstanceRepository,
            new \BristolSU\Support\EventStore\EventStoreRepository
        );
        $listener->handle($event);
