...
class ModuleBuilderTest extends TestCase
{
    ...
    /** @test */
    public function set_alias_sets_the_alias_in_the_module()
    {
    ...
    /** @test */
    public function set_name_sets_the_name_in_the_module()
    {
        $this->builder->create('alias1');
    ...
    /** @test */
    public function set_description_sets_the_description_in_the_module()
    {
        $this->builder->create('alias1');
    ...
    /** @test */
    public function set_settings_sets_the_settings_in_the_module()
    {
    ...
    /** @test */
    public function set_permissions_sets_the_permissions_in_the_module()
    {
        $this->builder->create('alias1');
    ...
    /** @test */
    public function set_triggers_sets_the_triggers_for_the_module()
    {
        $this->builder->create('alias1');
    ...
    /** @test */
    public function set_completion_conditions_sets_the_completion_conditions_for_the_module()
    {
        $this->builder->create('alias1');
    ...
    /** @test */
    public function set_triggers_only_sets_events_implementing_triggerable_event()
    {
        $this->builder->create('alias1');
    ...
    /** @test */
    public function set_service_request_sets_the_service_request()
    {
        $this->builder->create('alias1');
    ...
    /** @test */
    public function get_module_returns_the_built_module()
    {
    ...
    /** @test */
    public function get_alias_returns_the_alias()
    {
        $module = new \BristolSU\Support\Module\Module();

        $builder = new ModuleBuilderFake(
            $module,
            $this->permissionRepository->reveal(),
            $this->config->reveal(),
            $this->eventRepository->reveal(),
    ...
    /** @test */
    public function get_alias_throws_an_exception_if_no_alias_set()
    {
    ...
    /** @test */
    public function set_for_sets_the_for_in_the_module()
    {
        $this->builder->create('alias1');
