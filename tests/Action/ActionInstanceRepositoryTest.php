...
class ActionInstanceRepositoryTest extends TestCase
{
    ...
    {
        ActionInstance::factory()->count(5)->create(['module_instance_id' => 1, 'event' => 'event1']);
        $actionInstances = ActionInstance::factory()->count(5)->create(['module_instance_id' => 2, 'event' => 'event2']);
        ActionInstance::factory()->count(5)->create(['module_instance_id' => 2, 'event' => 'event3']);
        ActionInstance::factory()->count(5)->create(['module_instance_id' => 3, 'event' => 'event2']);
    ...
    {
        $actionInstances = ActionInstance::factory()->count(5)->create();
