...
class CompletionConditionManagerTest extends TestCase
{
    ...
    /** @test */
    public function get_for_module_returns_an_empty_array_if_no_conditions_registered()
    {
        $manager = new CompletionConditionManager();
    ...
    /** @test */
    public function get_class_from_alias_throws_an_exception_if_alias_not_found()
    {
