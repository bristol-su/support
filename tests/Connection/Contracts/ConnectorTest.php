...
class ConnectorTest extends TestCase
{
    ...
    /** @test */
    public function get_setting_returns_the_given_default_value_if_setting_not_found()
    {
        $connector = new DummyConnector($this->prophesize(Client::class)->reveal());
    ...
    /** @test */
    public function get_setting_returns_null_if_setting_not_found_and_no_default_given()
    {
        $connector = new DummyConnector($this->prophesize(Client::class)->reveal());
