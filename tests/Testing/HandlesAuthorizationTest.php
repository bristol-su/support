...
class HandlesAuthorizationTest extends TestCase
{
    ...
    /** @test */
    public function bypass_authorization_ensures_the_permission_tester_always_returns_true()
    {
    ...
    /** @test */
    public function give_permission_to_ensures_the_permission_tester_returns_true_for_the_given_permission()
    {
    ...
    /** @test */
    public function revoke_permission_to_ensures_the_permission_tester_returns_false_for_the_given_permission()
    {
