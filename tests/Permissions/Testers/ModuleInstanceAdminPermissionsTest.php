...
class ModuleInstanceAdminPermissionsTest extends TestCase
{
    ...
    public function can_calls_successor_if_module_instance_does_not_exist()
    {
        ...
        $tester = new ModuleInstanceAdminPermissions($app->reveal(), resolve(LogicTester::class), $this->prophesize(Authentication::class)->reveal());
    ...
    public function can_passes_the_authentication_attributes_to_the_logic_tester(){
        ...
        $tester = new ModuleInstanceAdminPermissions($app->reveal(), resolve(LogicTester::class), $authentication->reveal());
